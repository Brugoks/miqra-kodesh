...
const SECRETS: Array<{ name: string; usedBy: string; required: boolean }> = [
  ...
  { name: 'R2_ACCOUNT_ID', usedBy: 'R2 wiki images, event flyers, and storage metrics', required: false },
  { name: 'R2_ACCESS_KEY_ID', usedBy: 'R2 wiki images, event flyers, and storage metrics', required: false },
  { name: 'R2_SECRET_ACCESS_KEY', usedBy: 'R2 wiki images, event flyers, and storage metrics', required: false },
  { name: 'R2_BUCKET', usedBy: 'R2 wiki images, event flyers, and storage metrics', required: false },
  { name: 'R2_ENDPOINT', usedBy: 'R2 endpoint override for uploads and metrics', required: false },
