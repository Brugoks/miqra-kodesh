...
await fs.writeFile(path.join(root, `src/components/scene/${tableauOnly ? 'sceneTableauAssets' : 'sceneHumanAssets'}.js`),
  '// Generated by scripts/humans/package_characters.mjs. Source notices accompany the GLBs.\n' +
  `export const ${tableauOnly ? 'TABLEAU_MODEL_ASSETS' : 'HUMAN_MODEL_ASSETS'} = ${JSON.stringify(records, null, 2)};\n`);
